...
const CarouselList = forwardRef<HTMLDivElement, CarouselListProps>(
  ({ items, loading, isSmall, onEdit, onDelete }, ref) => {
    ...
    const canRight = ref && typeof ref !== 'function' && ref.current
      ? scroll < ref.current.scrollWidth - ref.current.clientWidth - 10
      : false;
              ...
              >
                ...
                >
                  {item.image ? (
                    ...
                    >
                      <PhotoIcon
                        sx={{ fontSize: 60, color: alpha(theme.palette.common.white, 0.2) }}
                      />
                    </Box>
                  )}
                </Box>
