...
const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      const result: RegisterResult = await register(userNtId, userRole);
  ...
  const handleUserNtIdChange = (e: React.ChangeEvent<HTMLInputElement>): void => {
    setUserNtId(e.target.value);
  };

  const handleUserRoleChange = (e: SelectChangeEvent<UserRole>): void => {
