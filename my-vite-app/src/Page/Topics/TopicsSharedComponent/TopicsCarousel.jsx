...
const ContentSection = styled(Box)(({ theme }) => ({
  ...
  textAlign: 'left',
  backgroundColor:
    theme.palette.mode === 'dark' ? '#1e2e4a' : '#eaeef4',
...
// Left & right arrow buttons - FIXED: removed background
...
const TopicsCarousel = ({ slides, carouselAriaLabel }) => {
  ...
  // Auto-advance slides every 3 seconds unless paused
  useEffect(() => {
    if (!isPaused) {
  ...
  return (
    ...
    >
      ...
      {/* Navigation Arrows - FIXED: removed background */}
      <StyledIconButton
