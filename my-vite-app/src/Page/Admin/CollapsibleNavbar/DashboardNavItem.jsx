...
const DashboardNavItem = ({ darkMode, isDrawerCollapsed, isActiveLink, setSelectedItem }) => {
  ...
  return (
    <ListItem disablePadding sx={{ display: 'block', mb: 0.8 }}>
      <Tooltip title={isDrawerCollapsed ? "Dashboard" : ""} placement="right" arrow>
        <ListItemButton
          onClick={handleClick}
          sx={{
            minHeight: 48,
        ...
        >
          ...
          >
            <DashboardIcon sx={{ transition: 'color 0.2s ease' }} />
          </ListItemIcon>
